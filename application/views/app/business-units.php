      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-6">
                <h1 class="m-0">Business Units</h1>
                <ol class="breadcrumb">
              ...
              <div class="col-6 d-flex align-items-center justify-content-end">
                ...
                <a href="<?= base_url('business-units/create'); ?>" class="btn btn-default btn-sm  ml-2">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center" width="15%">
                        <a href="<?= base_url('business-units/view/').$record['id']; ?>" class="btn btn-link btn-sm" data-toggle="tooltip" data-placement="top" title="View"> <i class="fas fa-eye"></i> </a>/<a href="<?= base_url('business-units/edit/').$record['id']; ?>" class="btn btn-link btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"> <i class="fas fa-edit"></i> </a>/<a href="<?= base_url('business-units/delete/').$record['id']; ?>" onClick="return confirm('This company will be deleted and can\'t be recovered. Are you sure to delete?');" class="btn btn-link btn-sm" data-toggle="tooltip" data-placement="top" title="Delete"> <i class="fas fa-trash"></i> </a>
                      </td>
                    </tr>
                    <?php $i++; } ?>
                  </tbody>
      ...
      $(function () {
        ...
        $("#delete-button").on('click', function () {
            ...
            if (confirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url("business-units/delete-selected"); ?>',
                    data: {
