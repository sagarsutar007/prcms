                              ...
                              <select name="gender" class="form-control" id="gender">
                                <?php 
                                    if (isset($record['gender'])){
                                      echo '<option value="'. $record['gender'] .'" hidden selected>'. ucfirst($record['gender']) . '</option>';
                                    }
                                ?>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-9 text-right">
                                <div class="form-group">
                                    ...
                                    <label for="same-addr" class="text-sm">Both adresses are same</label>
                                </div>
                              </div>
                            </div>
                            <hr>
